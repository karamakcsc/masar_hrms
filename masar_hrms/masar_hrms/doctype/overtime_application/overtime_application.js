...
//       frappe.call({
//           method: 'masar_hrms.masar_hrms.doctype.overtime_application.overtime_application.demo_salary_slip',
//           args: {
//             employee: "M1169",
...
//
//      let query_args = {
//          query: "masar_hrms.masar_hrms.doctype.overtime_application.overtime_application.get_employee_qry",
...
//         frappe.call({
//           method: "masar_hrms.masar_hrms.doctype.overtime_application.overtime_application.insert_selected_employee",
//           args: {
//             selected_employees: selected_employees
//           },
//           callback: function(r) {
//             $.each(r.message, function(i, d) {
//               var row = frappe.model.add_child(frm.doc, "Social Security Salary Line", "overtime_employees");
//               row.employee = d.name;
